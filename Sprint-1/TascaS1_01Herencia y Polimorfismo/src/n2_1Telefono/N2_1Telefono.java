...
Crea una classe anomenada "Smartphone" que sigui subclasse de "Telèfon" i 
que a la vegada implementi les interfícies "Camera" i "Rellotge".

El mètode fotografiar() ha de mostrar per consola: “S’està fent una foto” i 
el mètode alarma() ha de mostrar: “Està sonant l’alarma”.

Des del main() de l’aplicació, crea un objecte Smartphone i crida als mètodes anteriors.*/

public class N2_1Telefono {

	public static void main(String[] args) {
		
		Smartphone Meizu = new Smartphone ("Meizu","X16");
		
		Meizu.llamar("6898702149");
		Meizu.fotografiar();
		Meizu.alarma();
